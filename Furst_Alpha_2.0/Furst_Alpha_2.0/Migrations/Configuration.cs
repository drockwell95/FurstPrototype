namespace Furst_Alpha_2._0.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Furst_Alpha_2._0.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(Furst_Alpha_2._0.Models.ApplicationDbContext context)
        {
            ...
            {
                new Models {ModelId = 01, ModelName = "W515", Image = "https://furst.blob.core.windows.net/furst-media/Antari_W515.jpg" },
                new Models {ModelId = 02, ModelName = "G300", Image = "https://furst.blob.core.windows.net/furst-media/LeMaitre_G300.jpg" },
                new Models {ModelId = 03, ModelName = "Cubix 6 - CX6", Image = "https://furst.blob.core.windows.net/furst-media/Chauvet_Cubix_6_CH.JPG" },
                new Models {ModelId = 04, ModelName = "Escort 3000 - PE3000", Image = "https://furst.blob.core.windows.net/furst-media/Peavey_Escort_3000.jpg" },
                new Models {ModelId = 05, ModelName = "Ice 101", Image = "https://furst.blob.core.windows.net/furst-media/Antari_Ice101.jpg" },
                ...
                new Models {ModelId = 21, ModelName = "3sGerb", Image = "https://furst.blob.core.windows.net/furst-media/3sGerb.png" },
                new Models {ModelId = 22, ModelName = "6LGerb", Image = "https://furst.blob.core.windows.net/furst-media/6LGerb.png" },
                new Models {ModelId = 23, ModelName = "NPC30", Image = "https://furst.blob.core.windows.net/furst-media/NPC.jpeg" },
                new Models {ModelId = 24, ModelName = "NPG", Image = "https://furst.blob.core.windows.net/furst-media/NPG.jpeg" },
